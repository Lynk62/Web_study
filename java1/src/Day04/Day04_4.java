...
public class Day04_4 {//cs
	...
	public static void main(String[] args) {//ms
		...
		//배열 [ 특정(인덱스) 기준으로 나열 ]
			//여러개 변수를 저장/관리
			//1. 인덱스	: 저장되는 순서 번호 [0번부터 시작 ~ ]
			//2. [ ]	: 대괄호 사용
			//3. 동일한 자료형의 여러 변수를 관리
		//선언
			//1. 자료형[] 배열명;	2. 자료형 배열명[];
			//3. 자료형[] 배열명 = {데이터1, 데이터2, 데이터3 ~ }
			//4. 자료형[] 베열명 = new 자료형[길이]
				//길이 : 배열내 저장할 변수 개수
		...
		//for과 배열 활용
			//for(자료형 임시변수 : 배열명) { }
			//배열내 0번 인덱스부터 끝까지 하나씩 임시변수 대입 반복
		...
		//배열 출력
		System.out.println("score : " + score); 		//배열 이름 호출 = 메모리 주소값
		System.out.println("score[0] : " + score[0]); 	//0번째 인덱스의 데이터 호출
		System.out.println("score[1] : " + score[1]); 	//1번째 인덱스의 데이터 호출
		System.out.println("score[2] : " + score[2]); 	//2번째 인덱스의 데이터 호출
		...
		//for문 활용
			//배열자료형 임시변수명 : 배열명
		for(int temp:정수배열1) {
			//배열 내 인덱스 0번 ~ 끝까지 하나씩 데이터 temp에 저장 반복
				//1. 정수배열1[0] => temp 저장
				//2. 정수배열1[1] => temp 저장
				//3. 정수배열1[2] => temp 저장
