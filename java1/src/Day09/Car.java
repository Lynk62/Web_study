...
public class Car {//cs
	...
	int run() {//자동차 회전 [모든 타이어객체가 1회씩 회전] 메소드
		 ...
		 if(backLeftTire.roll() == false)	{stop(); return 3;}	// 리턴 = 3 [뒤왼쪽 타이어 펑크]
		 if(backRightTire.roll() == false)	{stop(); return 4;}	// 리턴 = 4 [뒤오른쪽 타이어 펑크]
		 return 0;	//리턴 0이면 펑크 x
	}
